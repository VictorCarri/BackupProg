...
/* Our headers */
#include "ConfigHandler/BaseConfigHandler.hpp" // Class def'n

/*
* Constructor. Reads the entire JSON file in as a string, then uses Boost.JSON to parse it as JSON and save it.
*/
BaseConfigHandler::BaseConfigHandler(FILESYSTEM_PATH confFilePath)
{
	try
	{
...
*/
void BaseConfigHandler::readFileIntoString(FILESYSTEM_IFSTREAM& strm)
{
...
*/
boost::json::value BaseConfigHandler::getOpts() const
{
	return options;
}
...
*/
void BaseConfigHandler::storeLastBackupTime()
{
